...
import { Calendar, Home, MapPin, Clock, ArrowRight, CheckCircle2, Loader2 } from 'lucide-react';
...
function ActionButton({ label, variant = 'primary' }: { label: string, variant?: 'primary' | 'secondary' }) {
  return (
    <button className={`w-full py-5 rounded-2xl text-[13px] font-extrabold transition-transform hover:scale-[0.98] active:scale-[0.95] ${
      variant === 'primary' 
